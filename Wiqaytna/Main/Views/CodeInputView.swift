...
open class CodeInputView: UIView {
    ...
    */
    open var bottomBorderColor = UIColor(red: 0.85, green: 0.87, blue: 0.90, alpha: 1.00) {
     ...
     */
    open var nextDigitBottomBorderColor = UIColor(red:0, green:0.88, blue:0.77, alpha:1) {
    ...
    */
    open var textColor: UIColor = UIColor(red:0, green:0.88, blue:0.77, alpha:1) {
